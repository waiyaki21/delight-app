        ...
        <div class="rounded-t mb-0 px-6 py-6">
          ...
          <div class="btn-wrapper text-center">
            <a href="{{ route('Google Auth') }}"
              class="bg-white active:bg-blueGray-50 text-blueGray-700 font-bold px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center text-xs ease-linear transition-all duration-150 cursor-pointer" type="button">
              <img alt="Delight Electronics Google Auth Register" class="w-5 mr-1" src="/img/google.svg"/>
              Google
            </a>
            {{-- <a href="#"
