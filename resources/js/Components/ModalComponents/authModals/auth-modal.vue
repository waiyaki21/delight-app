<template>
	<!-- Main modal -->
	<div id="auth-modal" tabindex="-1" data-modal-placement="top" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center ps flex" aria-modal="true" role="dialog" >
...
<script>
	import authUserForm 	from '../../FormComponents/Auth/authUserForm.vue';
	...
	export default {
		...
		methods: {
			closeModal() {
				this.$refs.authFormRefs.formFields();
