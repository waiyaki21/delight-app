<template>
    <!-- Main modal -->
    <div id="catergory-modal" tabindex="-1" data-modal-placement="top"
        ...
        <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg dark:bg-gray-700 border-2 border-gray-700 card-shadow2">
                ...
                <div class="container my-2">
                    <div class="row">
                        <div class="col-md-12">
                            <!-- <bannerCatergoryForm v-bind:catergory="catergory" @updated="update"></bannerCatergoryForm> -->
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    // import bannerCatergoryForm from '../../FormComponents/Catergory/bannerCatergory.vue';
    export default {
        props: [
            'catergory',
        ],
