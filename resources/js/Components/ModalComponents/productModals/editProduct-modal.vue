	            ...
	            <div class="container my-2">
	                <div class="row">
	                    <editProductForm
							...
							v-bind:catfile    	 = "catergory"
            				v-bind:brandfile     = "brand"
							v-bind:count         = "count"
							ref 				 = "editProductFormRefs"
							@reloadproducts 	 = "reload"
							@reloadproductsfiles = "reloadImages"
							@failurefiles		 = "failedImages"
							@successthumb		 = "reloadThumb"
							@failurethumb		 = "failedThumb"
                        ></editProductForm>  
	                </div>
	            </div>
	        </div>
...
<script>
	import editProductForm 	from '../../FormComponents/Product/editProduct.vue';
