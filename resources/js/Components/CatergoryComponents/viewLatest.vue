<template>
    <div>
        ...
        <div class="container bg-blueGray-50 dark:bg-gray-900 max-h-full" v-else>
            ...
            <!-- latest products  -->
            <!-- rows  -->
            <div class="max-w-md mx-auto my-2 bg-white hover:shadow overflow-hidden md:max-w-2xl border border-gray-200" v-for="product in products" v-if="showList">
                <div class="flex">
            ...
            <div class="row justify-center" v-if="showCard">
                <div class="col-sm-6 m-2 bg-white border border-gray-200 hover:shadow dark:bg-gray-800 dark:border-gray-700 item-card" v-for="product in products">
                    <a :href="'/product_show/'+product.id" class="flex justify-center">
                        <img class="width-hr py-2" :src="product.thumbnail_path" :alt="'Delight Electronics ' +product.name" style="height: 220px;width: 90% !important;" v-if="product.catergory.name == 'TVs'"/>
