<template>
    <div role="status" class="flex flex-col w-full mx-auto p-2 gap-2 md:gap-4 divide-y dark:divide-cyan-500 rounded-md divide-cyan-500 my-2">
    ...
    <p class="text-lg text-center text-cyan-600 dark:text-cyan-600 animate-pulse my-2 uppercase boldened">Loading...</p>
</template>
    ...
    export default {
        data() {
            return {
                ...
                smallClass : 'h-2.5 bg-cyan-300 rounded-full dark:bg-cyan-700 col-span-1 md:col-span-2',
                bigClass    : 'h-2.5 bg-cyan-300 rounded-full dark:bg-cyan-600 w-full md:mb-2.5 animate-pulse col-span-2 md:col-span-4'
            }
        },
