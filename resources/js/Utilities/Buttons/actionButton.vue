<template>
    ...
    <!-- <tooltip :id="id" :info="tooltipText"></tooltip> -->
</template>
...
export default {
    ...
    data() {
        return {
            ...
            // button options 
            defaultOptions: 'relative inline-flex rounded-md group items-center justify-between overflow-hidden text-sm md:text-lg font-normal uppercase focus:ring-1 focus:outline-none px-2 py-1 md:px-2 whitespace-nowrap',
            ...
            rosePlugin: 'dark:text-rose-800 dark:hover:text-gray-900 dark:bg-rose-100 dark:hover:bg-red-300 rounded-full text-sm p-2 border-lg dark:border-rose-800 border-rose-900 shadow-md mr-0 text-md',
            purplePlugin: 'bg-gradient-to-br from-purple-500 via-cyan-700 to-teal-800 hover:text-white dark:text-white rounded-full p-2 border-lg dark:border-purple-800 border-purple-900 shadow-md mr-0 text-md',
            infoPlugin: 'bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full p-2 border-lg dark:border-blue-500 border-blue-900 shadow-md mr-0 text-md',

            // rectangular classess
            defaultSubmit: 'relative inline-flex rounded-md group items-center justify-between overflow-hidden text-sm md:text-lg font-light uppercase focus:ring-1 focus:outline-none px-2 py-1 md:px-2 md:py-1.5 whitespace-nowrap',
